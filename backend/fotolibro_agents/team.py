...
from fotolibro_agents.agents.photo_analyzer import create_photo_analyzer
from fotolibro_agents.agents.motif_detector import create_motif_detector
from fotolibro_agents.agents.chronology_specialist import create_chronology_specialist
from fotolibro_agents.agents.story_generator import create_story_generator
from fotolibro_agents.agents.design_curator import create_design_curator
...
def process_fotolibro(
    ...
    from fotolibro_agents.agents.photo_analyzer import analyze_photo_batch
    from fotolibro_agents.agents.motif_detector import detect_event_motif
    from fotolibro_agents.agents.chronology_specialist import detect_chronology_type
    from fotolibro_agents.agents.story_generator import generate_photobook_story
    from fotolibro_agents.agents.design_curator import curate_design
